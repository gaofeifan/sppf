package com.linkmoretech.order.pay;

import com.linkmoretech.common.util.SpringUtil;
import com.linkmoretech.order.config.BaseConfig;
...
public class PayConstants {
	...
	public static String getOrderAsyncApplePayUrl(){
		return server+"/order/app/callback/apple/order";
	}
	 
	public static String getOrderAsyncWechatUrl(){
		return server+"/order/app/callback/wechat/order";
	} 
	
	public static String getRechargeAsyncWechatUrl(){
		return server+"/order/app/callback/wechat/recharge";
	}  
