...
import com.linkmoretech.common.Constants.SmsTemplate;
import com.linkmoretech.common.util.JsonUtil;
import com.linkmoretech.order.common.request.ReqSms;
import com.linkmoretech.order.config.BeanFactory;
import com.linkmoretech.order.config.SmsConfig;
...
public class SmsAliyunImpl {
	 ...
	 * @return
	 */ 
	public String getTemplateCode(ReqSms.SmsTemplate st) {
