...
public interface OrdersRepository extends JpaRepository<Orders, String> {
     ...
     * @return 订单
     * */
    List<Orders> findOrdersByUserIdAndStatusIn(Long userId, Integer... status);
	...
	List<Orders> getDayOfCancelOrderList(Long userId);
	...
	List<Orders> findFinishOrderList(Long userId, Long start);
}
