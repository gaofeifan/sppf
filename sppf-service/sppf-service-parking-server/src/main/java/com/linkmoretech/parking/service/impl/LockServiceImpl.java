...
import com.linkmoretech.parking.vo.response.ResSignalHistoryList;
...
//	private LockProperties lockProperties  = SpringUtil.getBean(LockProperties.class);
	/*{
		...
		try {
			...
			String sercret = properties.getProperty("lock.app-secret");
			String appId = getProperty("lock.app-id");
			String url = properties.getProperty("lock.linkemore-lock-url");
